export const generalSettingList = [
  ...
  },
  {
    ...
    desc: "When Books is running, your computer won't enter sleep mode",
...
export const dataSettingList = [
  ...
  },
  {
    ...
    desc: "Clicking the sync button will sync reading progress between Books and KOReader with KOReader sync server.",
...
export const syncSettingList = [
  {
    ...
    desc: "By default, Books will automatically synchronize your data when you open the app and exit reading",
